...
function createGalleryImgs(imgJSON) {
    ...
    for (let gallery in imgJSON) {
        ...
        for (let image of imgJSON[gallery]) {
            divEl.append("<div class='col-12 col-sm-6 col-md-4 col-lg-3'><img class='w-100' src='img/artwork/"+gallery+"/"+image+"' data-bs-target='#"+gallery+"-carousel' data-bs-slide-to='"+index+"'></div>");
            index += 1;
        }
    }
}
